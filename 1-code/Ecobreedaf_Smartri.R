...
d_intercrop=2*h
RunSimu(paramFileName=paramFileName,d_inter=h,d_intra=l,d_intercrop =NULL,designType ='quincunx2',  MAP=MAP,pathVpalmParam=pathVpalmParam,pathArchimed=pathArchimed,path_designs=path_designs,pathVpalmJar=pathVpalmJar,pathOpf=pathOpf,pathOPS=pathOPS,run_photosynthesis=T,opfStepExport=opfStepExport,overwrite =F,orientation="NS",twist=0,meteoFile =meteoFile )
